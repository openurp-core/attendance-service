...
import org.openurp.ws.services.teach.attendance.web.util.Consts.{ DeviceId, SigninDate, SigninTime, Rule }
import org.openurp.ws.services.teach.attendance.domain.DateFormats.{ toCourseTime, toDateStr, toTimeStr }
import org.openurp.ws.services.teach.attendance.web.util.Params
